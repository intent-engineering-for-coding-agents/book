...
This book is my attempt at the honest answer. It's about using AI **responsibly and professionally** to build real software. Not the kind that demos well on a Tuesday and falls apart on a Friday.

Let me say a few things up front.

**Vibe coding is fine. In its place.** It's excellent for fast prototyping and mockups. It's wonderful when you need to put something on a screen for a customer, get a feel for the shape of a feature, pull requirements out of someone who can't quite articulate them, or try three competing frameworks side by side to see which one fights you the least. I use it all the time for exactly that.

But a vibe-coded prototype has no business growing up into a production system. The right move, almost always, is to throw it away and start over with the real requirements in mind. That isn't new advice. It's been a mantra for decades, and decades ago it came with a caveat: throwing it away hurt. Rebuilding from scratch costs weeks. Today with an AI doing most of the construction, the rebuild cost collapses. Throwing away the prototype is no longer a painful decision. And the second build is better for every lesson the prototype taught: requirements sharpened, dead ends already eliminated, framework already chosen. The prototype was the conversation, not the product.
...
Here is the part the carousels leave out. If you give your AI enough up-to-date information about the system you intend to build and maintain, you can move past prototypes and produce **production-grade software**. But there is no shortcut around the work software developers have always been expected to do: proper analysis, design, coding, testing, deployment. Exactly what we were taught in school and university, and exactly what the carousels skip over because it doesn't sell.

Software development is still a craft. Humans must stay in the loop. The AI may catch up to more of this in time, and when it does, I'll happily revise this foreword. But for now the responsibility is ours: to be deliberate, to be professional, and to do the part of the job that humans still do best.

That's what the rest of this book is about. The **how**.
