...
3. [Trunk-Based Development with Agents](./trunk-based-development): change folders as short-lived branches; merge cadence; how spec deltas reduce merge pain
4. [Code Review for Agent-Generated Code](./code-review-agent-code): spec delta first, diff second; intent-first review; when splitting a PR is worth the overhead
5. [Shared AI Instruction Conventions](./shared-conventions): team-level `AGENTS.md`, shared `.agents/skills/` libraries, onboarding, and when to leave things divergent
