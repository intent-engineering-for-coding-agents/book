...
Proceed beyond readable when the artifact does not enforce itself. The best rule of all is what the tooling can impose on itself: a linted ADR, a spec you are expected to meet before the change matters. An intent a machine executes is longer-lived than an intent a developer has to memorize.
