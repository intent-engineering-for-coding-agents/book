...
Not every practice in this book needs to reach CI-enforced. Some pay off at practiced and the enforcement cost is not worth the work. A team that enforces a spec-before-code rule in code review does better work than one with a pipeline check and four dead specs. Each topic chapter marks the minimum level where the practice starts returning value, and what CI-enforced looks like when the team decides the investment is worth making.
