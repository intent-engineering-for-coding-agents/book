...
Foundation is the first topic for a reason. Without it, AI instructions have nowhere to live. Specs have no structure to enforce against. Quality checks have no conventions to validate.

The chapters in this section address the underlying problem — agents that are productive but contextless — and give it a shape you can act on.

## Chapters

1. [Why Structure Matters](./why-structure) — what compounding drift costs, and why structure is a context problem
2. [The Four Document Types](./four-document-types) — architecture, decisions, design, and specs each have a different lifespan
