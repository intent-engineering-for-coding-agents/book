...
Foundation is the first topic of Intent Engineering for a reason, and not the obvious one. It does not sit as a co-equal subject alongside intent. It grounds the agent so your intent becomes executable. Without it, AI instructions have nowhere to live. Specs have no structure to enforce against. Quality checks have no conventions to validate.
