...
- EPAM — ["Agentic Development Lifecycle (ADLC): A New Model for AI Systems Beyond SDLC"](https://www.epam.com/insights/ai/blogs/agentic-development-lifecycle-explained). *Feb 5, 2026*. Phase-0 governance + validation gates; ADLC literature for *building agents as products*, distinct scope from Intent Engineering.
