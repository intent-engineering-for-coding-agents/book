# IEC-TEAM-ANCHOR-SDLC: Anchor to Existing SDLC Primitives
...
- Intent Engineering practices that add new meeting types instead of extending existing PR reviews
...
Spec review happens in the PR, not in a separate meeting. The before-checkpoint is part of the PR template. The after-checkpoint is the CI pipeline. The team's existing workflow is the structure; Intent Engineering provides the content.
