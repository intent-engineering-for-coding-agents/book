...
7. **Voice** — does the prose match `voice.md`? No forbidden patterns, varied rhythm, narrative tension at openings, no generic summary endings, sections difficult to skim
