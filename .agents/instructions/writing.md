...
- Bold and italic emphasis (`**bold**`, `*italic*`) are the author's call, not a default. The author may reach for them whenever the rhythm of a sentence calls for it. When a coding or AI agent drafts prose, default to sentence structure to carry emphasis, and use bold or italic only when it clearly earns its place (a term introduced for the first time, a single word needing weight a comma cannot supply), never as a habit or on every page. Exceptions stand as before: inline code (backticks) is fine; book titles in Sources lines use quotes; the `Sources:` citation line itself is wrapped whole in italics (`*Sources: ...*`) to set it apart from body prose, and that wrapper is sanctioned only for the complete Sources line, never for emphasizing words inside it.
...
> can, may, just, that, very, really, literally, actually, certainly, probably, basically, could, maybe, delve, embark, enlightening, esteemed, shed light, craft, crafting, imagine, realm, game-changer, unlock, discover, skyrocket, abyss, not alone, in a world where, revolutionize, disruptive, utilize, utilizing, dive deep, tapestry, illuminate, unveil, pivotal, intricate, elucidate, hence, furthermore, however, harness, exciting, groundbreaking, cutting-edge, remarkable, it, remains to be seen, glimpse into, navigating, landscape, stark, testament, in summary, in conclusion, moreover, boost, skyrocketing, opened up, powerful, inquiries, ever-evolving, recipe
