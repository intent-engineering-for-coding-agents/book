...
- Do not present emerging conventions as standards unless the source supports that claim. Terms like `AGENTS.md`, ASE, ADLC variants, test taxonomies, and current agent workflows often need `de-facto`, `emerging`, `current practice`, or equivalent framing.
